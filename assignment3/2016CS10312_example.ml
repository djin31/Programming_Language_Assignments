...
mgu (Node(Sym "+",[Node(Sym "double",[V(Var "x")]);Node(Sym "double",[Node(Sym "0",[])])])) (Node(Sym "+",[V(Var "y");V(Var "y")]));;
mgu (Node(Sym "+",[Node(Sym "a",[]);V(Var "x");Node(Sym "double",[Node(Sym "double",[V(Var "z")])])])) (Node(Sym "+",[V(Var "z");Node(Sym "double",[V(Var "y")]);Node(Sym "double",[V(Var "y")])]));;
